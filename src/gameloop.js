...
async function playRound(algorithm1, algorithm2, curround, player1move, player2move) {
  let player1Score = 0;
  let player2Score = 0;
  ...
  if (
    ...
    if (show_choices) console.log("An error occurred. Did you enter a valid option?");
  }

  // Return scores for this round and also the moves made
  return { player1Score: player1Score, player2Score: player2Score , player1move: player1Decision, player2move: player2Decision};
}
